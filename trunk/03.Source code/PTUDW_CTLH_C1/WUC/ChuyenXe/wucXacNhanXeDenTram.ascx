<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucXacNhanXeDenTram.ascx.cs" Inherits="PTUDW_CTLH_C1.WUC.ChuyenXe.wucXacNhanXeDenTram1" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CalendarExtender ID="cleNgayKhoiHanh" runat="server" Format="dd/MM/yyyy" 
                        TargetControlID="txtNgayKhoiHanh">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" 
                        FilterType="Numbers" TargetControlID="txtGioXuatPhat">
                ...
                <td>
                    ...
                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" 
                        FilterType="Numbers" TargetControlID="txtGioDen">
                    </asp:FilteredTextBoxExtender>
                </td>
            </tr>
        </table>
        ...
        <p>
            <asp:GridView ID="gvChuyenXe" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:ButtonField CommandName="XemChiTiet" HeaderText="Chi tiet" 
                        Text="Chi tiet" />
                </Columns>
            </asp:GridView>
            <asp:Panel ID="pnlThongTinChuyen" runat="server" Visible="false">
                <asp:Label ID="Label7" runat="server" Text="Hien thi thong tin chi tiet"></asp:Label>
                <asp:FormView ID="fvChiTietChuyen" runat="server" DataKeyNames="MaChuyenXe" 
                    DataSourceID="ldsThongTinChiTietChuyen" DefaultMode="Edit" 
                    onitemcommand="fvChiTietChuyen_ItemCommand">
                    <EditItemTemplate>
                        <table>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="MaChuyenXeLabel1" runat="server" 
                                        Text='<%# Eval("MaChuyenXe") %>' />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="KhoiHanhTextBox" runat="server" ReadOnly="True" 
                                        Text='<%# Bind("KhoiHanh") %>' />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="DuKienDenTextBox" runat="server" ReadOnly="True" 
                                        Text='<%# Bind("DuKienDen") %>' />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="MaTuyenXeTextBox" runat="server" ReadOnly="True" 
                                        Text='<%# Bind("MaTuyenXe") %>' />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="GiaVeTextBox" runat="server" Height="22px" ReadOnly="True" 
                                        Text='<%# Bind("GiaVe") %>' />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="LuongTaiXeTextBox" runat="server" ReadOnly="True" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="MaXeTextBox" runat="server" ReadOnly="True" 
                                        Text='<%# Bind("MaXe") %>' />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cbTinhTrang" runat="server" 
                                        DataSourceID="ldsTinhTrangChuyen" DataTextField="MoTa" 
                                        DataValueField="MaTinhTrang" SelectedValue='<%# Bind("MaTinhTrang") %>'>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
...
<asp:LinqDataSource ID="ldsTinhTrangChuyen" runat="server" 
    ContextTypeName="DTO.CongTyLuHanhDataContext" TableName="TINH_TRANG_CHUYENs" 
    EnableUpdate="True">
</asp:LinqDataSource>
