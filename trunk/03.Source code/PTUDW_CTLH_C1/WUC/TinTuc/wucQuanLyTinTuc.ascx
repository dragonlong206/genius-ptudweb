...
<asp:FormView ID="fvDangTin" runat="server" DataKeyNames="MaTinTuc"
    DataSourceID="ldsChiTietTinTuc" DefaultMode="Insert" OnItemCommand="fvChiTietTinTuc_ItemCommand"
    OnItemInserted="fvDangTin_ItemInserted" OnItemInserting="fvDangTin_ItemInserting">
    <InsertItemTemplate>
        <table>
            <tr>
                <td>
